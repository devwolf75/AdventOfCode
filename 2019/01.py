...
f = open("01.txt", "r")
module_masses = [int(i) for i in f.readlines()]

fuel_requirement = 0
for mass in module_masses:
    fuel_requirement = fuel_requirement + (math.floor(mass / 3) - 2)
...
def calculate_additional_fuel(initial_fuel_mass):
    additional_mass = additional_mass + math.floor(initial_fuel_mass / 3) - 2
    if additional_mass > 0:
        return calculate_additional_fuel(additional_mass)
    return additional_mass


for mass in module_masses:
    fuel_requirement = fuel_requirement + calculate_additional_fuel(mass)
    additional_mass = 0
